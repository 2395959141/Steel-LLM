...
class CCI3_HQFormatHandler(FormatHandler):
    ...
    def process_one_line(self, line, fout) -> bool:
        ...
        try:
            ...
            # 构建输出数据
            output = {"text": processed_text, "source": data.get("id", ""), "score": data.get("score", 0)}
            fout.write(json.dumps(output, ensure_ascii=False) + "\n")
            return True
...
def main_run():
    input_path_root = "/DATA/disk2/yuhang/.cache/modelscope/datasets"
    output_path_root = "/DATA/disk2/yuhang/.cache/steel_dataset/step1_unified_format"
    if not os.path.exists(output_path_root):
        os.makedirs(output_path_root)
